    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 md:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
          <h1 className="text-2xl sm:text-3xl font-bold">夕飯はこれ！</h1>
          <div className="flex gap-2 sm:gap-4 w-full sm:w-auto">
            <Link
              href="/calendar"
              className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 text-center text-sm sm:text-base touch-manipulation"
            >
              月間カレンダー
            </Link>
            <Link
              href="/recipes"
              className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-center text-sm sm:text-base touch-manipulation"
            >
              レシピ一覧
            </Link>
          </div>
